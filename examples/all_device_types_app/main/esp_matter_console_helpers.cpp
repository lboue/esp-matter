...
public:
    MyCommodityTariffDelegate() {
        ...
        static CommodityTariff::Structs::DayEntryStruct::Type entries[2];
        ...
        dayEntries.SetNonNull(List<CommodityTariff::Structs::DayEntryStruct::Type>(entries, 2));
        ...
        static CommodityTariff::Structs::TariffComponentStruct::Type components[2];
        ...
        tariffComponents.SetNonNull(List<CommodityTariff::Structs::TariffComponentStruct::Type>(components, 2));
        
        ESP_LOGI("CommodityTariff", "MyCommodityTariffDelegate initialized with complete tariff structure");
    }
};
