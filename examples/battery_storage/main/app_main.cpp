...
extern "C" void app_main()
{
    ...
    battery_storage::config_t battery_storage_config;
    endpoint_t *endpoint = battery_storage::create(node, &battery_storage_config, ENDPOINT_FLAG_NONE, NULL);
    ABORT_APP_ON_FAILURE(endpoint != nullptr, ESP_LOGE(TAG, "Failed to create battery_storage endpoint"));

    battery_storage_endpoint_id = endpoint::get_id(endpoint);
    ESP_LOGI(TAG, "Battery storage created with endpoint_id %d", battery_storage_endpoint_id);
